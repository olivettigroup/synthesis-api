...
class ParagraphQueryAddRemoveTester(TestCase):
    def setUp(self):
        ...
        self.previousPaSize = self.pa_collection.count()
        self.previousQySize = self.qy_collection.count()


    def single(self):
        # Adding a paragraph
        result = phelpers.add_paragraphs(self.connection, self.material_id_1, self.paragraph_data_1, 0)
        ...
        self.assertTrue(self.pa_collection.count() - self.previousPaSize == 1)
        self.assertTrue(paragraph_object is not None)

        # Checking that the query object was created
        self.assertTrue(self.qy_collection.count() - self.previousQySize == 1)
        ...
        phelpers.remove_paragraphs(self.connection, self.material_id_1, self.paragraph_data_1, 0)
        ...
        self.assertTrue(self.previousQySize - self.qy_collection.count() == 0)

        # Removing the paragraph
        self.pa_collection.remove(self.paragraph_data_1)
        self.assertTrue(self.previousPaSize - self.pa_collection.count() == 0)

    def multiple(self):
        phelpers.add_paragraphs(self.connection, self.material_id_1, self.paragraph_data_1, 0)
        phelpers.add_paragraphs(self.connection, self.material_id_2, self.paragraph_data_2, 0)
        ...
        self.assertTrue(self.pa_collection.count() - self.previousPaSize == 2)
        ...
        self.assertTrue(self.qy_collection.count() - self.previousQySize == 2)
        self.assertTrue(query_object_1 is not None)
        self.assertTrue(query_object_2 is not None)
        
        # Removing the paragraph
        phelpers.remove_paragraphs(self.connection, self.material_id_1, self.paragraph_data_1, 0)
        phelpers.remove_paragraphs(self.connection, self.material_id_2, self.paragraph_data_2, 0)
        ...
        self.assertTrue(self.qy_collection.count() - self.previousQySize == 0)

        # Removing the paragraph
        self.pa_collection.remove(self.paragraph_data_1)
        self.pa_collection.remove(self.paragraph_data_2)
        self.assertTrue(self.pa_collection.count() - self.previousPaSize == 0)

    def interleaved_multiple(self):
        phelpers.add_paragraphs(self.connection, self.material_id_1, self.paragraph_data_1, 0)
        phelpers.add_paragraphs(self.connection, self.material_id_2, self.paragraph_data_2, 0)
        phelpers.add_paragraphs(self.connection, self.material_id_1, self.paragraph_data_3, 0)

        # Checking that the paragraph objects was created
        paragraph_object_1 = self.pa_collection.Paragraph.find_one(self.paragraph_data_1) 
        paragraph_object_2 = self.pa_collection.Paragraph.find_one(self.paragraph_data_2) 
        paragraph_object_3 = self.pa_collection.Paragraph.find_one(self.paragraph_data_3) 
        self.assertTrue(self.pa_collection.count() - self.previousPaSize == 3)
        self.assertTrue(paragraph_object_1 is not None)
        self.assertTrue(paragraph_object_2 is not None)
        ...
        self.assertTrue(self.qy_collection.count() - self.previousQySize == 3)
        self.assertTrue(query_object_1 is not None)
        self.assertTrue(query_object_2 is not None)
        ...
        phelpers.remove_paragraphs(self.connection, self.material_id_2, self.paragraph_data_2, 0)
        phelpers.remove_paragraphs(self.connection, self.material_id_1, self.paragraph_data_3, 0)
...
class ParagraphGetTester(TestCase):
    ...
    def get_one(self):
        ...
        self.assertTrue(paragraphs[0]['doi'] == 1)
    
        phelpers.remove_paragraphs(self.connection, self.material_id_1, self.paragraph_data_1, 0)

    def get_many(self):
        phelpers.add_paragraphs(self.connection, self.material_id_1, self.paragraph_data_1, 0)
        phelpers.add_paragraphs(self.connection, self.material_id_1, self.paragraph_data_2, 0)

        paragraphs = phelpers.get_paragraphs_of_query(self.connection, self.material_id_1, 5)
        self.assertTrue(len(paragraphs) == 2)

        phelpers.remove_paragraphs(self.connection, self.material_id_1, self.paragraph_data_1, 0)
        phelpers.remove_paragraphs(self.connection, self.material_id_1, self.paragraph_data_2, 0)

    def get_mix(self):
        phelpers.add_paragraphs(self.connection, self.material_id_1, self.paragraph_data_1, 0)
        phelpers.add_paragraphs(self.connection, self.material_id_1, self.paragraph_data_2, 0)
        phelpers.add_paragraphs(self.connection, self.material_id_2, self.paragraph_data_3, 0)
        ...
        phelpers.remove_paragraphs(self.connection, self.material_id_1, self.paragraph_data_1, 0)
        phelpers.remove_paragraphs(self.connection, self.material_id_1, self.paragraph_data_2, 0)
        phelpers.remove_paragraphs(self.connection, self.material_id_2, self.paragraph_data_3, 0)
